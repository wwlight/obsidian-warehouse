...
- [W3Schools.com](https://www.quanzhanketang.com/) - W3Schools Online Web Tutorials
- [CodeGym](https://codegym.cc/zh/) - 在线 Java 语言编程课程
- [Exercism](https://exercism.org/) - 免费在线编程
- [GitHub Copilot](https://copilot.github.com/) - 您的 AI 结对程序员
- [AppWorks](https://github.com/apptools-lab/AppWorks) - 基于 VS Code 插件的前端研发工具集
- [Awehunt](https://awehunt.com/)
- [WEB骇客](https://www.webhek.com/) - HTML5, CSS3, WEB 前端开发技术
- [设计达人](https://www.shejidaren.com/) - 爱设计，爱分享
- [Ruff](https://ruff.io/zh-cn/) - 软件定义硬件，支持 JavaScript 开发应用的物联网操作系统
- [RSSHub](https://docs.rsshub.app/) - 一个开源、简单易用、易于扩展的 RSS 生成器，可以给任何内容生成 RSS 订阅源
```
````
...
- [Icônes](https://icones.js.org/) - 即时搜索图标资源管理器
...
- @ [CSS Generators](https://css-generators.com/) - 形状元素 CSS 生成器 `[!!tip: hot]`
- @ [Coupon.io](https://coupon.codelabo.cn/) - 生成优惠券 UI CSS 代码
- $ [Neumorphism](https://neumorphism.io/) - 生成新形态设计
- $ [FANCY-BORDER-RADIUS](https://9elements.github.io/fancy-border-radius/) - 花式边界半径
- & [CSS Scan](https://getcssscan.com/css-box-shadow-examples) `[!!tip: hot]` - 漂亮的 CSS 盒子阴影示例
...
- [Relingo](https://relingo.net/) - 无压力不打扰学习英语单词 | Chrome 插件
- [Trancy](https://www.trancy.org/) -  ChatGPT 助手和 YouTube/Netflix 双字幕 | Chrome 插件
...
- [最美网站](https://zuimeix.com/) - 国内外优秀网站推荐导航
- [致美化](https://zhutix.com/) - 最专业的桌面美化交流平台
- [系统下载](https://xitongxiazai.org/) - 提供软件原版相关信息，不提供破解和正版授权
- [第一PPT](https://www.1ppt.com/) - PPT 背景图片，PPT 模板免费下载
- [适用于苹果芯片了吗？](https://isapplesiliconready.com/zh) - 已经为 M1 版 MacBook 优化的 macOS 应用程序之完整指南
- [Ventoy](https://www.ventoy.net/cn/index.html) - 新一代多系统启动 U 盘解决方案
